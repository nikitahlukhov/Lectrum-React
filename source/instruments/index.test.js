...
describe('instruments:', () => {
    ...
    test('getFullApiUrl function should throw, when called with non-string type as both arguments', () => {
        expect(() => getFullApiUrl(2, 2)).toThrow();
    });  

    test('getFullApiUrl function should produce special kind of string', () => {
        expect(getFullApiUrl('lol', 'olo')).toBe('lol/olo');
    }); 
});